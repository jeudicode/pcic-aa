...
X_median = median_train.iloc[:,:10]
y_median = median_train[[10]]
X_median_test = median_test.iloc[:,:10]
y_median_test = median_test[[10]]

X_mode = mode_train.iloc[:,:10]
y_mode = mode_train[[10]]
X_mode_test = mode_test.iloc[:,:10]
y_mode_test = mode_test[[10]]

y_mean = np.ravel(y_mean)
y_mean_test = np.ravel(y_mean_test)
y_median = np.ravel(y_median)
y_median_test = np.ravel(y_median_test)
y_mode = np.ravel(y_mode)
y_mode_test = np.ravel(y_mode_test)
